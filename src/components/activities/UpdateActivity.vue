<template>
  <div class="flex justify-center items-center">
    <div class="bg-white">
      ...
      <form @submit.prevent="updatectivity" class="grid grid-cols-2 gap-4">
...
const fetchActivity = async () => {
  ...
  await requestStore.getData(
    `${import.meta.env.VITE_API_URL}/admin/activities/${id}`,
    tokenStore.token || undefined
  );
  item.value = requestStore.fetchedData.activity;
