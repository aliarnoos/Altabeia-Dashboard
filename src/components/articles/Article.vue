...
const updateArticle = async () => {
  ...
  const content = {
    ...
    subTitleKu: subTitle.value.ku,
    subTitleEn: subTitle.value.en,
    subTitleAr: subTitle.value.ar,
    subTitleTu: subTitle.value.tu,
    ...
    buttonKu: button.value.ku,
    buttonEn: button.value.en,
    buttonAr: button.value.ar,
    buttonTu: button.value.tu,
    buttonUrl: button.value.url,
    buttonTwoKu: buttonTwo.value.ku,
    buttonTwoEn:  buttonTwo.value.en,
    buttonTwoAr:  buttonTwo.value.ar,
    buttonTwoTu:  buttonTwo.value.tu,
    buttonTwoUrl:  buttonTwo.value.url,
  };
